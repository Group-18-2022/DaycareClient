...
public class fakeGUI
{
    ...
    public static void main(String[] args)
    {
        ...
        Child c = ChildFactory.createChild
                ("id001", "Toddler", "Baby", "12 diamond ave", "11-12-2019", "male");

        //2. urls for the DayCareVenue class. Try using your own class's links'
        String createUrl = "http://localhost:8080/api/v1/day-care/child/save/";
        String deleteUrl = "http://localhost:8080/api/v1/day-care/child/delete/";
        String readUrl = "http://localhost:8080/api/v1/day-care/child/read/";
        ...
        //new ConsoleApp().post(c,createUrl);
